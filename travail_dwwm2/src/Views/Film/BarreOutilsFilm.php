<div class="outils-action">
  ...
  <img class="logo-action visible" src="/assets/img/Corbeille.svg" alt="Supprimer" title="Supprimer le film" onclick="location.href='/dashboard/films/delete/<?= $film->getId() ?>'; event.stopPropagation();">
